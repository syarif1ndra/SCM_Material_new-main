        ...
        <ul class="nav flex-column pt-3 text-white mt-3">
          <li class="nav-item">
            <a class="nav-link {{ Request::is('/') ? 'active' : '' }} ps-4 text-white " href="{{ route('dashboard')}}">
              <i class="bi bi-house-fill pe-2"></i> <span>Dashboard Pemasok</span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('pemasok*') ? 'active' : '' }} ps-4" href="{{route('user.pemasok.index')}}">
              <i class="bi bi-people pe-2"></i> <span>Pemasok</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('kontrak*') ? 'active' : '' }} ps-4" href="#">
