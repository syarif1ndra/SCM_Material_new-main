    ...
    <div>
      ...
      <div id="sidebar" class="sidebar collapsed position-fixed min-vh-100 mt-5 d-none d-sm-block d-md-block d-lg-block d-xl-block">
        <ul class="nav flex-column pt-3 text-white mt-3">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('pengiriman*') ? 'active' : '' }} ps-4" href="{{route('admin.pengiriman.index')}}">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('kontrak*') ? 'active' : '' }} ps-4" href="{{route('admin.kontrak.index')}}">
              <i class="bi bi-people pe-2"></i> <span>Kontrak</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('proyek*') ? 'active' : '' }} ps-4" href="{{ route('admin.proyek.index') }}">
              <i class="bi bi-file-earmark-text pe-2"></i> <span>Proyek</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('') ? 'active' : '' }} ps-4" href="{{route('profile.edit')}}">
          ...
          <li class="nav-item">
            <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                @csrf
                <button type="submit" class="btn btn-link nav-link ps-4">
      ...
      <div class="offcanvas offcanvas-start d-md-none  min-vh-100" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel" style="width: 250px; background-color:  #654321;">
        ...
        <div class="offcanvas-body d-flex flex-column p-0 ">
          ...
          <ul class="nav flex-column">
            ...
            <!-- Dropdown Pengiriman -->
            <li class="nav-item">
              <a class="nav-link" href="{{route('admin.pengiriman.index')}}">
